package blueocean.wellnesswaves.app;
...
import blueocean.wellnesswaves.app.CView;
import blueocean.wellnesswaves.app.SView;
import blueocean.wellnesswaves.app.SView.ISplashListener;
...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (DO_XML) {
            ...
            mSplashView = (SView) findViewById(R.id.splash_view);
        } else {
            // create the main view
            mMainView = new FrameLayout(getApplicationContext());

            // create the splash view
            mSplashView = new SView(getApplicationContext());
    ...
    private void onLoadingDataEnded() {
        ...
        mContentView = new CView(context);
